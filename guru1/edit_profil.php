...
{    
    ...
    if(empty($kode_mapel) || empty($nisn) || empty($nilai_uts) || empty($nilai_uas) || empty($nilai_ulha) || empty($nilai_akhir)) {    
        ...
        //updating the table
        $sql = "UPDATE data_nilai SET kode_mapel=:kode_mapel, nilai_uts=:nilai_uts, nilai_uas=:nilai_uas, nilai_ulha=:nilai_ulha, nilai_akhir=:nilai_akhir WHERE nisn=:nisn";
