...
<?php
      ...
      $edited=mysqli_query($con, "UPDATE login_siswa SET NISN='$x',password='$a' where id_siswa='$id_siswa'");
...
<!-- end -->
 ...
 <?php
          ...
          //query
          $sql = mysqli_query($con, "SELECT * FROM login_siswa WHERE id_siswa = '$id_siswa'");
...
<form action="akun_update_siswa.php?id_siswa=<?php echo $id_siswa; ?>" name="updatedataku" method="post">
<td>
    <div class="form-group">
      <label ></label>
      <input value="<?php echo $data['id_siswa']; ?>" type="hidden" name="id_siswa" class="form-control"  style="width:300px;">
    </div>
    <div class="form-group">
      <label >NISN:</label>
